...
import static org.jsoup.nodes.Entities.EscapeMode.user;
...
public class Entities {
    ...
    public enum EscapeMode {
		...
		user(EntitiesData.userPoints, 5);
    ...
    public static boolean isUserNamedEntity(final String name) {
        return user.codepointForName(name) != empty;
    }
    ...
    public static String getByName(String name) {
        ...
        codepoint = user.codepointForName(name);
        if (codepoint != empty)
            return new String(new int[]{codepoint}, 0, 1);
        return emptyName;
    }
