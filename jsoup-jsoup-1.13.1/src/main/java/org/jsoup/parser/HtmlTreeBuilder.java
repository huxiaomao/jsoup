...
public class HtmlTreeBuilder extends TreeBuilder {
	...
	public void setNodePos(Node node) {
		node.setCharStartPos(currentToken.charStartPos());
	...
	private void printPos(Node node) {
		...
		String text = node.nodeName() + ",S:" + node.charEndPos() + ",E:" + node.charEndPos() + "<----->BS:"
				+ node.byteStartPos() + ",BE:" + node.byteEndPos();
