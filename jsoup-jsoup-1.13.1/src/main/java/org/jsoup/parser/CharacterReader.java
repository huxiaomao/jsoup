...
public final class CharacterReader {
	...
	private void setBytePos(String consumed) {
		bytePos += consumed.getBytes().length;
	}

	private void incrementBytePos() {
		bytePos++;
	}

	private void decrementBytePos() {
		bytePos--;
	}
    ...
    public String consumeToAny(final char... chars) {
        ...
        bufPos = pos;
        String consumed = pos > start ? cacheString(charBuf, stringCache, start, pos -start) : "";
        setBytePos(consumed);
        return consumed;
    }
    ...
    String consumeToAnySorted(final char... chars) {
        ...
        bufPos = pos;
        String consumed = bufPos > start ? cacheString(charBuf, stringCache, start, pos -start) : "";
        setBytePos(consumed);
        return consumed;
    }
    ...
    String consumeLetterSequence() {
        ...
        String consumed = cacheString(charBuf, stringCache, start, bufPos - start);
        setBytePos(consumed);
        return consumed;
    }
